          ...
          >
            ...
            >
              <div className="relative inline-block">
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-white shadow-xl shadow-birthday-pink/30 mx-auto">
                  <img
            ...
            <motion.p
              className="text-3xl md:text-4xl font-display font-bold text-birthday-lavender mb-4"
            ...
            {/* Birth date */}
            <motion.div
              className="flex items-center justify-center gap-2 text-xl text-birthday-coral mb-10"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
